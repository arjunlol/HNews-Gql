...
class Resolvers::LinksSearch
  # include SearchObject for gql
  include SearchObject.module(:graphql)

  # scope is starting point for sreach
  scope { Link.all }

  # return type
  type !types[Types::LinkType]

  # inline input type definition for advance filter
  ...
  # when filter passed apply filter called to narrow scope
